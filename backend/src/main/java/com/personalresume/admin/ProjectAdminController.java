...
import com.personalresume.admin.dto.ProjectRequest;
...
import com.personalresume.domain.project.ProjectExperience;
...
public class ProjectAdminController {
    ...
    public ProjectAdminController(ProjectExperienceRepository repository, ProfileRepository profileRepository) {
    ...
    @PostMapping
    public ApiResponse<?> create(@Valid @RequestBody ProjectRequest request) {
    ...
    @PutMapping("/{id}")
    public ApiResponse<?> update(@PathVariable Long id, @Valid @RequestBody ProjectRequest request) {
        ProjectExperience entity = repository.findById(id)
                .orElseThrow(() -> new ResourceNotFoundException("project not found"));
    ...
    private void map(ProjectExperience entity, ProjectRequest request, Long profileId) {
